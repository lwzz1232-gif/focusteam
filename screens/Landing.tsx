    ...
    <div className="min-h-screen bg-[#05050A] text-slate-200 font-sans selection:bg-blue-500/30 overflow-x-hidden">
          ...
          <Reveal delay={300} center width="100%">
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mt-10 w-full">
              ...
              >
                ...
                <div className="flex items-center gap-2"><span>Find a Partner</span><ArrowRight size={18} className="group-hover:translate-x-1 transition-transform"/></div>
              </button>
              <button 
          ...
          <div className="mt-20 relative max-w-4xl mx-auto w-full">
             ...
             <div className="relative bg-slate-900 border border-slate-700/50 rounded-2xl p-2 shadow-2xl backdrop-blur-sm">
                <div className="flex items-center justify-between px-4 py-3 bg-slate-950/50 rounded-t-xl border-b border-slate-800">
                   <div className="flex gap-2"><div className="w-3 h-3 rounded-full bg-slate-700"></div><div className="w-3 h-3 rounded-full bg-slate-700"></div></div>
                   <div className="text-xs font-mono text-slate-500 flex items-center gap-2"><div className="w-2 h-2 rounded-full bg-red-500 animate-pulse"></div> LIVE SESSION</div>
                </div>
                <div className="grid grid-cols-2 gap-2 p-2">
                   <div className="aspect-video bg-slate-800 rounded-lg relative overflow-hidden group">
                      <img src="https://raw.githubusercontent.com/lwzz1232-gif/focusteam/refs/heads/main/pexels-diimejii-3466163.jpg" className="w-full h-full object-cover opacity-60 group-hover:opacity-80 transition-opacity" alt="You" />
                   ...
                   <div className="aspect-video bg-slate-800 rounded-lg relative overflow-hidden group border border-blue-500/30">
                      <img src="https://raw.githubusercontent.com/lwzz1232-gif/focusteam/refs/heads/main/pexels-fauxels-3184163.jpg" className="w-full h-full object-cover opacity-60 group-hover:opacity-80 transition-opacity" alt="Partner" />
                      <div className="absolute inset-0 flex items-center justify-center"><div className="w-12 h-12 rounded-full bg-blue-600/20 flex items-center justify-center backdrop-blur-sm border border-blue-500/50"><Activity size={20} className="text-blue-400" /></div></div>
                      <div className="absolute bottom-3 left-3 bg-blue-600/80 backdrop-blur px-2 py-1 rounded text-[10px] font-mono text-white flex items-center gap-1"></div>
                   </div>
                </div>
      ...
      <section id="how-it-works" className="py-32 px-6 relative overflow-hidden">
        <div className="max-w-6xl mx-auto relative z-10">
          <Reveal width="100%"><div className="mb-20 text-center md:text-left"><h2 className="text-4xl md:text-6xl font-bold text-white mb-6">The Ritual.</h2><p className="text-xl text-slate-400 max-w-xl mx-auto md:mx-0">We've stripped away the noise. No scheduling, no calendars, no small talk. Just pure flow state on demand.</p></div></Reveal>
          <div className="grid md:grid-cols-3 gap-8 relative">
             ...
             {[{step: "01",title: "Set Your Intent",desc: "Log in and define what you need to accomplish in the next +30 minutes. Writing it down makes it real.",icon: MousePointer2},{step: "02",title: "Instant Match",desc: "Our algorithm finds a partner anywhere in the world who is ready to start right now. No waiting.",icon: Users},{step: "03",title: "Deep Work",desc: "Greet your partner, mute your mic, and work. The presence of another human keeps you honest.",icon: Lock}].map((item, idx) => (
               <Reveal key={idx} delay={idx * 200}>
                 <SpotlightCard className="h-full p-8 bg-black/40 backdrop-blur-sm relative z-10 group">
                    <div className="w-12 h-12 rounded-xl bg-slate-900 border border-slate-800 flex items-center justify-center mb-6 shadow-lg group-hover:scale-110 group-hover:border-blue-500/50 transition-all duration-300"><item.icon className="text-slate-200 group-hover:text-blue-400 transition-colors" size={24} /></div>
      ...
      <section className="py-32 bg-slate-900/20 px-6 border-y border-white/5">
         <div className="max-w-5xl mx-auto">
            <Reveal center width="100%"><div className="text-center mb-16 w-full"><h2 className="text-3xl md:text-5xl font-bold text-white mb-4">Why Body Doubling Works</h2><p className="text-slate-400">It's not magic. It's psychology.</p></div></Reveal>
            <div className="grid md:grid-cols-2 gap-12">
               <Reveal delay={100} width="100%"><div className="h-full p-8 rounded-2xl bg-red-950/10 border border-red-900/20 relative overflow-hidden hover:border-red-900/40 transition-colors"><div className="absolute top-0 right-0 p-4 opacity-10"><img src="https://cdn-icons-png.flaticon.com/512/564/564619.png" className="w-32 h-32 invert" alt="" /></div><h3 className="text-xl font-bold text-red-200 mb-4">Working Alone</h3><ul className="space-y-4 text-red-200/60"><li className="flex gap-3"><span className="text-red-500">✕</span> Prone to phone distractions</li><li className="flex gap-3"><span className="text-red-500">✕</span> "I'll do it in 5 minutes" mentality</li><li className="flex gap-3"><span className="text-red-500">✕</span> Easy to quit when it gets hard</li><li className="flex gap-3"><span className="text-red-500">✕</span> Isolated and unmotivated</li></ul></div></Reveal>
               <Reveal delay={300} width="100%"><div className="h-full p-8 rounded-2xl bg-blue-950/20 border border-blue-500/30 relative overflow-hidden hover:border-blue-500/50 transition-colors"><div className="absolute top-0 right-0 p-4 opacity-10"><Users size={120} className="text-blue-400" /></div><h3 className="text-xl font-bold text-blue-200 mb-4 flex items-center gap-2">With FocusTwin <Check size={18} className="text-blue-400" /></h3><ul className="space-y-4 text-blue-100/80"><li className="flex gap-3"><span className="text-blue-400">✓</span> Social pressure keeps you seated</li><li className="flex gap-3"><span className="text-blue-400">✓</span> Scheduled starts kill procrastination</li><li className="flex gap-3"><span className="text-blue-400">✓</span> Seeing others focus inspires you</li><li className="flex gap-3"><span className="text-blue-400">✓</span> 50-minute blocks maximize flow</li></ul></div></Reveal>
            </div>
         </div>
      </section>
        ...
        <Reveal center width="100%">
          <div className="w-full">
            ...
            <div className="space-y-4">
               {[{ q: "Do I have to talk to my partner?", a: "Barely. You say hello, state your goal, and mute. The goal is silence." },{ q: "Is video mandatory?", a: "Yes. Being seen is what creates the accountability. We do not record anything." },{ q: "Is it free?", a: "Yes, FocusTwin is currently 100% free for our beta community." },{ q: "What happens if my partner leaves?", a: "We'll notify you instantly and give you the option to re-match." }].map((faq, i) => (
                 <div key={i} className="group border border-white/5 rounded-lg bg-white/[0.02] hover:bg-white/[0.05] transition-colors">
                   <details className="p-6 cursor-pointer"><summary className="font-medium text-slate-200 flex justify-between items-center list-none select-none">{faq.q}<ChevronDown className="group-open:rotate-180 transition-transform text-slate-500" /></summary><p className="mt-4 text-slate-400 leading-relaxed text-sm">{faq.a}</p></details>
                 </div>
               ))}
            </div>
          </div>
      ...
      <section className="py-32 relative text-center px-6 overflow-hidden">
         ...
         <Reveal center width="100%">
            <div className="relative z-10 flex flex-col items-center justify-center">
               <h2 className="text-5xl md:text-7xl font-bold text-white mb-8 tracking-tight">Your best work is <br/> <span className="italic font-serif text-blue-400">waiting for you.</span></h2>
               <p className="text-slate-400 mb-10 text-lg">Join thousands of others who have reclaimed their attention.</p>
               <button onClick={() => navigate('/login')} className="px-12 py-5 bg-white text-black font-bold rounded-full text-xl hover:scale-105 transition-transform shadow-[0_0_50px_-10px_rgba(255,255,255,0.3)]">Start a Session Now</button>
            </div>
         </Reveal>
      </section>
      ...
      <footer className="py-12 px-6 border-t border-white/5 bg-black text-center md:text-left">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
           <div className="flex items-center gap-2 opacity-50 hover:opacity-100 transition-opacity"><Logo className="w-6 h-6" /><span className="font-bold text-slate-300">FocusTwin</span></div>
           <div className="text-sm text-slate-600">© 2025 FocusTwin. Built for deep work.</div>
        </div>
      </footer>
    </div>
  );
